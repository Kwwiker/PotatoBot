...
public class VKCore {
    ...
    public VKCore() throws ClientException, ApiException {
        ...
        // подгружаем TOKEN и groupId из файла настроек
    ...
    public Message getMessage() throws ClientException, ApiException {
        ...
        if (!messages.isEmpty() && !messages.get(0).isOut()) {
            ...
            /**
             * messageId - максимально полученный ID,
             * нужен, чтобы не было ошибки 10 internal server error,
             * который является ограничением в API VK.
             * В случае, если ts слишком старый (больше суток),
             * а max_msg_id не передан, метод может вернуть ошибку 10
